...
module Readability
  class Document
    ...
    REGEXES = {
        ...
        :negativeRe => /combx|comment|comments|contact|foot|footer|footnote|link|media|meta|promo|related|scroll|shoutbox|sponsor|tags|widget/i,
    ...
    def score_paragraphs(min_text_length)
      candidates = {}
      @html.css("p,td,div").each do |elem|
